...
export const touchesData = [
    ...
    new ToucheViewModel("302f67a6-5933-4168-a766-711fa829d9c4", "𝝿", "𝝿", TypeTouche.PI, "function pi"),
    new ToucheViewModel("9f033e9e-d673-49f5-a1f5-5327f5119ee0", "𝑥ʸ", "^", TypeTouche.PUISSANCE, "function xy"),
    new ToucheViewModel("91c8c53a-11e2-42fe-b114-d10c1a83cbe9", "Rand", Math.floor(Math.random()*100).toString(), TypeTouche.CHIFFRE, "function rand"),
    ...
    new ToucheViewModel("5aaeedde-8dc5-434a-a00e-77493b9cbc21", ")", ")", TypeTouche.CLEAR, "function parc"),
